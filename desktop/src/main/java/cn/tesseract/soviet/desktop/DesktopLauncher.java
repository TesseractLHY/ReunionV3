...
/**
 * Desktop entry point. Registers mod hooks, then delegates to the real game main.
 *
 * Usage: replace the game's main class with this one:
 *   java -cp "game-lib.jar;libs/*;mods/*" cn.tesseract.soviet.desktop.DesktopLauncher [game args...]
 */
public class DesktopLauncher {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            new DesktopMod().registerHooks();
        } catch (Exception e) {
            SovietLogger.e("DesktopLauncher", "Failed to register hooks", e);
        }
